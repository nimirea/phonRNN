...
First, we include all required functions for the analysis, including some custom functions from `analysis/utils.R` and other packages from CRAN.
...
daland_et_al_2011 <- "../baselines/Daland-et-al_2011.csv"
...
wilcox.test(phonol_aware$value, phonol_naive$value)
